...
public class main {
    //static final int maxSize = 1500000;//鍐呭瓨姣忔鏈�澶氭斁1500000鏉¤褰�
    static final int maxSize = 15000;//鍐呭瓨姣忔鏈�澶氭斁1500000鏉¤褰�
    ...
    public static void test(File inputFile, File outputFile, File tempFile) throws Exception {
        ...
        String line = null;//鐢ㄦ潵瀛樻斁姣忔浠庣紦鍐插尯璇诲叆鐨勪竴鏉¤褰�
        int i = 0;//缁熻鍚戠紦鍐插尯璇诲叆浜嗚褰曟潯鏁�
