package com.pinganfu.test.tree.btree2;
public class BTree<Key extends Comparable<Key>, Value>  
{
    ...
    public static void main(String[] args) 
    {
        ...
        st.put("7", "128.112.136.12");
        st.put("8", "128.112.136.11");
        st.put("9",    "128.112.128.15");
        st.put("10",    "128.112.128.17");
      ...
      /*  System.out.println("cs.princeton.edu:  " + st.get("www.cs.princeton.edu"));
        ...
        System.out.println();
*/
        System.out.println("hardvardsucks.com: " + st.get("8"));
