...
public class RedBlackTree {
	...
	// This function performs a left rotation around the node 鈥榵鈥�.
	...
	// This function performs a right rotation around the node 鈥榵鈥�.
	...
	// A function to delete the node 鈥榸鈥� from a red-black tree. It has a time complexity of O(log n).
	...
	// This function searches the Red Black Tree for a node with ID = 鈥榵', and returns the node if found. 
	...
	// This function calls the search() function to find a node with ID = 鈥榵鈥�. 
	...
	// This function calls the search() function to find a node with ID = 鈥業D鈥�. 
	// If found, it then increases the count of that node by 鈥榤鈥�, and prints the count after increasing. 
	// Else, it calls the insert() function passing 鈥業D鈥� and 鈥榤鈥� as arguments. 
	...
	// This function calls the search() function to find a node with ID = 鈥業D鈥�. 
	// If found, it then decreases the count of that node by 鈥榤鈥�, and prints the count after decreasing. 
	// However, if the count <= 0 after decreasing, the delete function() is called passing the node as an argument. 
	// If the node is not present or is removed, then 鈥�0鈥� is printed. 
	// The time complexity of this function in O(log n).
	...
	// This function calls the search() function to find a node with ID = 鈥業D鈥�. 
	// If found, the function then prints the count of the found node. Else, it prints 鈥�0鈥�. 
	...
	// which identify the next and previous nodes with value of 鈥業D鈥� around the value of 鈥榢ey鈥�, 
	...
	// This function calls the findNextPrev() function, passing 鈥榬oot鈥�, 鈥榬es鈥�, and 鈥業D鈥� as parameters, 
	// and prints the returned next node鈥檚 ID and count, if a next node was found. 
	...
	// This function calls the findNextPrev() function, passing 鈥榬oot鈥�, 鈥榬es鈥�, and 鈥業D鈥� as parameters, 
	// and prints the returned previous node鈥檚 ID and count, if a previous node was found. 
	...
	// This function has a time complexity of O(log n + s) where 鈥榮鈥� is the number of IDs in the range.
